...
for i in range(randint(0, len(new_consonant_inventory) - 1)):
...
if randint(0, 1) == 1 and 'fricative' in types_of_articulation:
    # adding possible rhotic; you decide how you want to pronounce it
    fricatives.append('r')
...
for i in numbers:
    for j in persons:
        for k in tenses:
            for l in moods:
                new_ending = generate_word(1, plosives[randint(0, len(plosives) - 1)],
...
for i in cases:
    for j in numbers:
        new_ending = generate_word(1, plosives[randint(0, len(plosives) - 1)], plosives[randint(0, len(plosives) - 1)],
                                   fricatives[randint(0, len(fricatives) - 1)],
...
for thing in deriv_morph:
    if randint(0, 1) == 1:
        derivational_morphology[thing] = generate_word(1, plosives[randint(0, len(plosives) - 1)],
                                                       plosives[randint(0, len(plosives) - 1)],
                                                       fricatives[randint(0, len(fricatives) - 1)],
                                                       fricatives[randint(0, len(fricatives) - 1)],
                                                       vowels[randint(0, len(vowels) - 1)],
...
for word in real_words:
    ...
    if word in english_words:
        ...
        while recon != word:
            ...
            reps += 1
            if reps > 10:
                new_word += generate_word(randint(1, 2), plosives[randint(0, len(plosives) - 1)],
                                          plosives[randint(0, len(plosives) - 1)],
                                          fricatives[randint(0, len(fricatives) - 1)],
                                          fricatives[randint(0, len(fricatives) - 1)],
                                          vowels[randint(0, len(vowels) - 1)], vowels[randint(0, len(vowels) - 1)])
