            ...
            if self.place_of_articulation == 'dental' or self.place_of_articulation == 'alveolar':
                ...
                if self.is_voiced == False:
                    if self.is_aspirated == False:
                        ...
                        return_val = 'qxh'
        if self.is_ejective == True and self.place_of_articulation != 'glottal' and self.type_of_articulation == 'plosive' and self.is_voiced == False and return_val != '' and self.is_aspirated == False:
            return_val += "'"
...
for word in english_words:
    new_word = generate_word(english_words.index(word), total)
